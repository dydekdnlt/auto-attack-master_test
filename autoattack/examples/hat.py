...
def hat_loss(model, x, y, optimizer, step_size=0.007, epsilon=0.031, perturb_steps=10, h=3.5, beta=5.0, gamma=1.0,
    ...
    x_hr = x + h * (x_adv - x)
    with ctx_noparamgrad_and_eval(hr_model):  # hr_model 설정
